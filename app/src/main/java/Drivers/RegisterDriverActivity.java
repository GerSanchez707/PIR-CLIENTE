...
public class RegisterDriverActivity extends AppCompatActivity {
    ...
    @BindView(R.id.tietRemisera)
    TextInputEditText tietRemisera;
    @BindView(R.id.tilRemisera)
    TextInputLayout tilRemisera;

    @BindView(R.id.tietAptonoVidentes)
    TextInputEditText tietAptonoVidentes;
    @BindView(R.id.tilAptonoVidentes)
    TextInputLayout tilAptonoVidentes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tietRemisera.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(!tietRemisera.getText().toString().trim().isEmpty())
                    tietRemisera.setError(null);
        ...
        tietAptonoVidentes.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(!tietAptonoVidentes.getText().toString().trim().isEmpty())
                    tietAptonoVidentes.setError(null);
        ...
        btnRegistrarCuenta.setOnClickListener(v -> {
            if (tilEmail.getError() == null && tilPassword.getError() == null) {
                validateInputs(Objects.requireNonNull(tietNombreCompleto.getText()).toString().trim(),
                        ...
                        Objects.requireNonNull(tietRemisera.getText()).toString().trim(),
                        Objects.requireNonNull(tietAptonoVidentes.getText()).toString().trim()
