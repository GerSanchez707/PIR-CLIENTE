...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (getApplicationContext() != null) {
                    ...
                    mMarker= mMap.addMarker(new MarkerOptions().position(
                            new LatLng(location.getLatitude(), location.getLongitude())
                                    ...
                                    .title("Tu posicion")
                                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_ubicaci_n_del_usuario_100))
                    );
                    */
    ...
    private void requestDriver(){
        ...
        if(mOriginLatLng != null && mDestinationLatLng != null)
        {
            ...
            Toast.makeText(this,"Debe seleccionar el punto de partida y el destino",Toast.LENGTH_SHORT).show();
        }
    ...
    private  void limitSearch()
    {
        ...
        mAutocomplete.setLocationBias(RectangularBounds.newInstance(southSide,nortSide));
        mAutocompleteDestination.setCountry("ARG");
        mAutocompleteDestination.setLocationBias(RectangularBounds.newInstance(southSide,nortSide)); }
